...
const RegisterPage = () => {
  const handleFingerprintRegister = () => {
    // Registration logic for fingerprint
    console.log("Attempting fingerprint registration...");
  };
  const handleMetaMaskRegister = () => {
    // Registration logic for MetaMask
    console.log("Attempting MetaMask registration...");
  };
  return (
    <div className="min-h-screen bg-background flex items-center justify-center p-4 relative overflow-hidden">
      ...
      <Card className="w-full max-w-md relative z-10 bg-card/80 backdrop-blur-xl border-border/50 shadow-card">
        ...
        <CardContent className="space-y-6">
          ...
          <Button variant="fingerprint" size="lg" onClick={handleFingerprintRegister} className="w-full h-16 text-lg">
          ...
          <Button variant="metamask" size="lg" onClick={handleMetaMaskRegister} className="w-full h-16 text-lg">
          ...
          <div className="text-center">
            <p className="text-xs text-muted-foreground">Already have an account? <a href="/" className="text-primary underline hover:text-primary/80">Login here</a></p>
          </div>
        </CardContent>
      </Card>
    </div>
